...
export const LEARNING_VIDEOS: LearningVideo[] = [
  {
    id: 'vid-1',
    title: '지구온난화와 기후변화의 원인과 치명적 영향 (Causes and Effects of Climate Change)',
    channel: 'National Geographic (내셔널 지오그래픽)',
    category: '지구온난화',
    duration: '03:04',
    youtubeId: 'G4H1N_yXBiA',
    summary: '내셔널 지오그래픽이 제작한 대표적인 기후변화 개론 영상으로 화석연료 연소와 온실가스 배출, 지구 평균 기온 상승, 극지 빙하 융해와 극한 기상이변이 생태계에 미치는 파급효과를 알기 쉽게 설명합니다.',
    keyPoints: [
      '화석연료 연소와 무분별한 벌목으로 인한 대기 중 이산화탄소(CO2) 농도의 전례 없는 급증',
      '온실효과로 인한 지구 평균 기온 상승 및 극지 빙하 해빙으로 인한 글로벌 해수면 상승 위협',
      '기상이변(슈퍼 폭염, 가뭄, 홍수) 빈도 증가와 해양 산성화로 인한 해양 생태계 파괴'
    ],
    presenterTakeaway: '기후변화는 먼 미래의 가설이 아닌 지금 우리 눈앞에서 벌어지는 현실이며, 즉각적인 전 지구적 탄소 감축 행동이 필수적입니다.'
  },
  {
    id: 'vid-2',
    title: '온실가스는 지구를 어떻게 데울까? (How Do Greenhouse Gases Actually Work?)',
    channel: 'MinuteEarth & 과학 아카이브',
    category: '지구온난화',
    duration: '03:10',
    youtubeId: 'sTvqIijqvTg',
    summary: '질소나 산소와 달리 이산화탄소, 메탄, 수증기 등 온실가스 분자가 지표면에서 방출되는 적외선 복사열을 흡수하고 재방출하는 분자 물리학적 메커니즘을 직관적인 애니메이션으로 규명합니다.',
    keyPoints: [
      '전기적으로 비대칭인 3원자 이상의 기체 분자(CO2, H2O, CH4)만이 특정 파장의 적외선 열에너지를 흡수',
      '흡수된 적외선 에너지가 분자를 진동시키며 사방으로 열을 재방출하여 지표면 보온 효과 발생',
      '작은 온실가스 농도 증가도 지구 전체의 정밀한 열수지 균형을 무너뜨리는 과학적 이유'
    ],
    presenterTakeaway: '온실효과는 지구의 생명을 지켜온 자연 법칙이지만, 인류의 과도한 배출로 균형이 깨진 것이 온난화의 근본 원인입니다.'
  },
  {
    id: 'vid-3',
  ...
  {
    id: 'vid-4',
    title: '우리는 기후변화를 해결할 수 있습니다! (We WILL Fix Climate Change!)',
    channel: 'Kurzgesagt – In a Nutshell',
    category: '탄소중립',
    duration: '16:15',
    youtubeId: 'LxgMdjyw8uw',
    summary: '기후위기에 대한 막연한 공포와 절망을 넘어, 지난 10년간 태양광·풍력·배터리 단가의 극적인 하락과 전 세계적인 에너지 전환 노력이 만들어낸 희망적인 전환점을 과학 데이터로 제시합니다.',
    keyPoints: [
      '재생에너지 발전 비용이 10년 새 90% 가까이 하락하여 화석연료보다 경제성이 높아진 세계적 현실',
      '최악의 파국 시나리오에서 벗어나 1.5°C~2°C 이하 억제를 향한 세계 각국의 탈탄소 정책과 투자 가속화',
      '개인의 무력감을 극복하고 사회적 규범과 청정에너지 시장을 변화시키는 시민 연대의 파급력'
    ],
    presenterTakeaway: '기후위기는 해결 불가능한 운명이 아닙니다. 인류가 올바른 도구와 결단을 내릴 때 충분히 극복할 수 있습니다.'
  },
  {
    id: 'vid-5',
    title: '우리의 지구(Our Planet): 기후변화와 생태계 서식지의 경고',
    channel: 'Netflix 다큐멘터리 & Sir David Attenborough',
    category: '생태계보존',
    duration: '50:40',
    youtubeId: 'XmtXC_n6X6Q',
    summary: '넷플릭스와 세계 최고 자연 다큐 제작진이 제작하여 교육용으로 전편 공개한 명작으로, 급변하는 기후 속에서 야생 생태계가 겪는 도전과 지구 생물다양성 보존의 절대적 가치를 생생하게 보여줍니다.',
    keyPoints: [
      '사막화 가속과 초원 지대의 기상이변이 대형 초식동물과 맹수 서식지에 미치는 연쇄적 위협',
      '수자원 고갈과 토양 황폐화가 지역 생태계와 인류의 식량 안보에 미치는 광범위한 영향',
      '자연 스스로 회복할 수 있는 생태 회랑 구축과 해양·산림 보호구역 지정의 중요성'
    ],
    presenterTakeaway: '자연을 지키는 것은 동식물만을 위한 것이 아니라 인류 자신의 존속과 지속 가능한 미래를 위한 최우선 과제입니다.'
  }
];
